                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                          <?php
                            if($_SESSION['ncg-active']['ROLE']=="Admin"){?>
                               <a class="nav-link" href="javascript:void(0);">Admin Manual</a>
                          <?php }else{?>
                            <a class="nav-link" href="ncg_manual">User Manual</a>
                          <?php }?>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="faqs" style="border-bottom: 3px solid #fff; border-radius: 0;">FAQs</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="faq container" style="margin-top: 300px!important">
        ...
        <div class="faq-layouting layout-spacing">
            ...
            <div class="fq-article-section">
                <div class="row">
                    <div class="col-lg-2 col-md-2 mb-lg-0 mb-4 mt-5" >
                        <div style="height: 240px!important; background-image: url(assets/img/ww_logo.png); background-position: center; background-repeat: no-repeat; background-size: 120px; padding: 40px;">
                            
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-lg-0 mb-4 mt-5" >
                   ...
                   <?php
                    ...
                    <div class="col-lg-6 col-md-6 mb-lg-0 mb-4 mt-5">
                        <div class="card" style="height: 240px!important;">
                            <div class="card-body">
