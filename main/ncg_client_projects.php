...
$page = "INYATSI PROJECTS";
    ...
    if(isset($_GET['response'])){
          ...
          $client_data = NCG_FUNCT::GET_CUSTOMER($cid);
        ?>
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <h3>Project List | <strong><?php echo $client_data['CLIENT_NAME']?></strong>
                         ...
                         <?php }?>
                              ...
                              <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                ...
                                <div class="modal-content">
                                  <form method="post"  action="ncg_client_projects">
                                    <div class="modal-header">
                                        <h4>Add Project for <?php echo $client_data['CLIENT_NAME']?></h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                                        </button>
                                        <input type="hidden" name="projectClient" value="<?php echo $cid ?>">
                                    </div>
                                        ...
                                        <div id="circle-basic" class="">
                                          ...
                                          <section class="">
                                           <div class="input-group mb-4">
                                              ...
                                              <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Project Name" name="pname" requred >
                                            </div>
                                            <div class="row">
                                            <div class="col-sm-12">
                                            <div class="input-group mb-4">
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <button type="submit" class="btn btn-primary" name="new-project-secondary-jl21">Save</button>
                                  </div>
                              </form>
                                </div>
                              </div>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="alter_pagination" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                      <?php 
                                        $projects = NCG_FUNCT::GET_AFFILIATE_PROJECT($cid);
                                        while($project = $projects ->fetch_assoc()){
                                            ...
                                            if($_SESSION['ncg-active']['ROLE'] == "Admin" || NCG_FUNCT::IS_ASSIGNED($_SESSION['ncg-active']['UID'], $project['PROJECT_ID']) || NCG_FUNCT::IS_SPECIAL($_SESSION['ncg-active']['UID'])){
                                        ?>
                                        <tr>
