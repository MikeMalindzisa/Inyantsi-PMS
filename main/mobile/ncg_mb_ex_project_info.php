...
<!-- BEGIN LOADER -->
    ...
    <div class="helpdesk container" style="margin-bottom: 50px;">
        ...
        <nav class="navbar navbar-expand navbar-light">
            <a class="navbar-brand" href="ncg_mb_ex_home.php" style="width:70px; border-radius: 25px; background-color: #dddddd; padding-left: 4px; margin: 0px; height: 35px; line-height: 100%;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link ellipsis" href="ncg_mb_ex_settings.php"><?php echo $project_info['PROJECT_NAME']?></a>
                    </li>
                </ul>
            </div>
        </nav>
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area animated-underline-content">
                                    ...
                                    <ul class="nav nav-tabs  mb-3 navbar navbar-expand navbar-light" id="animateLine" role="tablist" style="margin-top: 50px; z-index: 99999; background-color: #fff; box-shadow: 0px 11px 7px 3px rgb(0 0 0 / 0%), 0 0px 0px 0 rgba(0, 0, 0, 0.12), 0 6px 20px -5px rgba(0, 0, 0, 0.2);">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="animated-underline-dates-tab" data-toggle="tab" href="#animated-underline-dates" role="tab" aria-controls="animated-underline-dates" aria-selected="true">Delivery Dates</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="animated-underline-pay-cert-tab" data-toggle="tab" href="#animated-underline-pay-cert" role="tab" aria-controls="animated-underline-pay-cert" aria-selected="false">Pay Cert</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="animated-underline-variation-order-tab" data-toggle="tab" href="#animated-underline-variation-order" role="tab" aria-controls="animated-underline-variation-order" aria-selected="false">VO</a>
                                        </li>
                                        <li class="nav-item">
                                            <?php
                                               $dom = "pid=".$pid."&from=ncg_mb_ex_project_info";
                                    ...
                                    <div class="tab-content" id="animateLineContent-4" style="margin-top: 55px; margin-bottom: 55px;">
                                        <div class="tab-pane fade active show" id="animated-underline-dates" role="tabpanel" aria-labelledby="animated-underline-dates-tab">
                                                ...
                                                <hr/>
                                                <p>
                                                <span style="font-weight: lighter; color: #258AED; font-size: 18px;"> New Date: <?php echo $new_date; ?></span>
                                                <br>
                                        ...
                                        if(mysqli_num_rows($payment_certificates) > 0){
                                              ...
                                              <hr style=" background-color: #000!important" />
                                                ...
                                                <?php 
                                                  ...
                                                  $dirty_data = NCG_FUNCT::MAKE_DIRTY($dom);
                                                  ?>
                                                    <a class="navbar-brand" href="ncg_mb_ex_cert_info?xyz=<?=$dirty_data?>" style="float: right; font-size: 16px;">Vew Details <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                                                    </a>
                                                    <br>
                                                </p> 
                                        ...
                                        <div class="tab-pane fade" id="animated-underline-variation-order" role="tabpanel" aria-labelledby="animated-underline-variation-order-tab">
                                            <p class="mb-4" style="background-color: #F0F0F0; border: 1px solid #000; padding: 10px; ">
                                                  <strong>Start Contract Amnt: </strong><?php echo $project_info['CURRENCY']." ".NCG_FUNCT::MINIFY_NUMBER($project_info['CONTRACT_VALUE'])?>
                                                  <br>
                                                  <strong>Curr Contract Amnt: </strong><?php echo $project_info['CURRENCY']." ".NCG_FUNCT::MINIFY_NUMBER($project_finances['CURRENT_VALUE'])?>
                                                  <br>
                                                  <br>
                                                  <strong>Total VO Amnt: </strong><?php echo $project_info['CURRENCY']." ".NCG_FUNCT::MINIFY_NUMBER($project_finances['VARIATION_VALUE'])?>
                                                </p>
                                        ...
                                        if(mysqli_num_rows($variation_orders) > 0){
                                              ...
                                              <hr/>
                                                <p>
                                                <span style="font-weight: lighter; color: #258AED; font-size: 18px;"> VO Amnt: <?php echo $project_info['CURRENCY']." ".NCG_FUNCT::MINIFY_NUMBER($variation_order['VO_AMOUNT'])?></span>
                                                <br>
                                                <span style="font-weight: lighter; color: #258AED; font-size: 18px;"> New Contract Amnt: <?php echo $project_info['CURRENCY']." ".NCG_FUNCT::MINIFY_NUMBER($variation_order['NEW_CONTRACT_VALUE'])?></span>
                                                <br>
                                                ...
                                                <br>
                                                  ...
                                                  <br>
                                                  <br>
                                                  <strong>Created By: </strong><?php echo $createdBy?>
                                                  <br>
                                                  <strong>Created Date: </strong><?php echo $created_on?>
                                                </p> 
