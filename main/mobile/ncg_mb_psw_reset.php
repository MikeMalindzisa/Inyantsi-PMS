...
<div class="form-container outer helpdesk">
        ...
        <nav class=" navbar navbar-expand navbar-light">
           <a class="navbar-brand" href="ncg_mb_login.php" style="width:70px; border-radius: 25px; background-color: #dddddd; padding-left: 4px; margin: 0px; height: 35px; line-height: 100%;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link ellipsis" href="#">Password Reset</a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="form-container">
                    <div class="form-content" style="display: block;">
                        <div class="col-md-12 text-center" style="margin-top: 35px;">
                            ...
                            <p class="ps-reset"><span style="font-weight: bold;">Note:</span> You will receive reset instructions in your email after this request is validated.</p>
                        </div>
                        <center><p style="color: #ff0000;"><?php echo $m?></p></center>
                        <form class="text-left" method="post" action="ncg_mb_psw_reset.php">
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" name="mb-psw-recovery">SUBMIT</button>
                                    </div>
                                </div>
                                <p class="signup-link">Cancel and <a href="ncg_mb_login.php">Login</a></p>
                            </div>
                        </form>
