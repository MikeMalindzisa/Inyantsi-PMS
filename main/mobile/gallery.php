    ...
    <div class="helpdesk container" style="margin-bottom: 50px;">
      <?php
        ...
        <nav class="navbar navbar-expand navbar-light">
            <a class="navbar-brand" href="<?=$_GET['from']?>?xyz=<?=$dirty_data?>" style="width:70px; border-radius: 25px; background-color: #dddddd; padding-left: 4px; margin: 0px; height: 35px; line-height: 100%;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link ellipsis" href="javascript:void(0);">Project Gallery</a>
                    </li>
                </ul>
            </div>
        </nav>
                  ...
                  <div class="col-md-12 mb-5 mt-5">
                    ...
                    if(mysqli_num_rows($gallery_files) <= 0){?>
                       <center>
                              ...
                              <h4>No content available.</h4></center>
                    <?php }else{?>
                                                   ...
                                                   <div class="card-body">
                                                       ...
                                                       <div class="meta-info">
                                                           ...
                                                           <div class="meta-action">
                                                               ...
                                                               <a href="../<?=$path?>" ><div class="action-icon act-view">
        ...
        <div class="container">
            <div class="row">
                <center><div class="navbar navbar-expand navbar-light">
                        ...
                        <div class="col-sm-4 col-lg-4 nav-link">
                            <a class="" href="ncg_mb_about.php"><center><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-info"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>About</center></a>
                        </div>
                        <div class="col-sm-4 col-lg-4 nav-link">
